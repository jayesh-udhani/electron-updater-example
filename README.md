...
**NOTE:** If you want to run through this whole process, you will need to fork this repo on GitHub and replace all instances of `jayesh-udhani` with your GitHub username before doing the following steps.
...
6. Release the release on GitHub by going to <https://github.com/jayesh-udhani/electron-updater-example/releases>, editing the release and clicking "Publish release."

7. Download and install the app from <https://github.com/jayesh-udhani/electron-updater-example/releases>.
